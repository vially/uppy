...
module.exports = function (_Plugin) {
  ...
  Dashboard.prototype.showPanel = function showPanel(id) {
    ...
    var plugin = this.uppy.getPlugin(id);
    console.log(plugin, id);
    if (plugin.opts.onTabSelect) {
      plugin.opts.onTabSelect();
    }
  };
  ...
  Dashboard.prototype.initEvents = function initEvents() {
    ...
    // Drag Drop
    this.removeDragDropListener = dragDrop(this.el, function (files, pos, fileList, directories) {
      _this5.handleDrop(files, directories);
    });
  ...
  Dashboard.prototype.handleDrop = function handleDrop(files, directories) {
    var _this7 = this;
